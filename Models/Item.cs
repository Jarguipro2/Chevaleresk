...
namespace EFA_DEMO.Models
{
    ...
    public partial class Item
    {
        ...
        [Display(Name = "Efficacité d'arme")]
        public Nullable<int> Efficacite { get; set; }

        [Display(Name = "Genre d'arme")]
        public Nullable<int> Genre { get; set; }

        [Display(Name = "Description d'arme")]
        public string Description { get; set; }

        [Display(Name = "Matière")]
        public string Matiere { get; set; }

        [Display(Name = "Poid d'armure")]
        public Nullable<int> Poid { get; set; }

        [Display(Name = "Taille d'armure")]
        public Nullable<int> Taille { get; set; }

        [Display(Name = "Effet de potion")]
        public string Effet { get; set; }

        [Display(Name = "Durée de potion")]
